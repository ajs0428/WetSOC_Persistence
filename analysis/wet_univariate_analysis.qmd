...
```{r}
summarize_glmm(HLEF_HFF, response = "carbon_perc", predictor = "HPU")
...
summarize_glmm(HLEF_HFF, response = "depth_cm", predictor = "HPU")
```
...
```{r}
summarize_glmm(HLEF_HFF_14C_DC_AO_trans, response = "Fe_mg_gSoil_DC", predictor = "HPU")
summarize_glmm(HLEF_HFF_14C_DC_AO_trans, response = "Fe_mg_gSoil_AO", predictor = "HPU")
summarize_glmm(HLEF_HFF_14C_DC_AO_trans, response = "Fe_AODC_ratio", predictor = "HPU")
summarize_glmm(HLEF_HFF_14C_DC_AO_trans, response = "Al_mg_gSoil_DC", predictor = "HPU")
summarize_glmm(HLEF_HFF_14C_DC_AO_trans, response = "Al_mg_gSoil_AO", predictor = "HPU")
summarize_glmm(HLEF_HFF_14C_DC_AO_trans, response = "Al_AODC_ratio", predictor = "HPU")
summarize_glmm(HLEF_HFF_14C_DC_AO_trans, response = "Ca_mg_gSoil_AO", predictor = "HPU")
summarize_glmm(HLEF_HFF_14C_DC_AO_trans, response = "Ca_mg_gSoil_DC", predictor = "HPU")
summarize_glmm(HLEF_HFF_14C_DC_AO_trans, response = "Mn_mg_gSoil_AO", predictor = "HPU")
summarize_glmm(HLEF_HFF_14C_DC_AO_trans, response = "Mn_mg_gSoil_DC", predictor = "HPU")
```
...
```{r}
summarize_glmm(HLEF_HFF_14C_DC_AO_trans, response = "HFF_mgC_gSoil", predictor = "HPU")
summarize_glmm(HLEF_HFF_14C_DC_AO_trans, response = "HFF_mgC_gSoil", predictor = "depth_cm")
summarize_glmm(HLEF_HFF_14C_DC_AO_trans, response = "HFF_mgC_gSoil", predictor = "depth_cm*HPU")
